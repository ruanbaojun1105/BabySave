...
public class ConnectionClientTest extends DefaultHttpClient {
    public ConnectionClientTest(Credentials cred,HttpParams httpParams,SchemeRegistry registry) {
    ...
    public ConnectionClientTest(Credentials cred, int port,HttpParams httpParams,SchemeRegistry registry) throws KeyManagementException, NoSuchAlgorithmException, KeyStoreException, UnrecoverableKeyException {
        super(new ThreadSafeClientConnManager(httpParams, registry), httpParams);
