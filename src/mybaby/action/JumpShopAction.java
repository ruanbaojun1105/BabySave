 ...
 * @author bj
 */
public class JumpShopAction extends Action implements Serializable{
	private static final long serialVersionUID = 1L;
	public static String actionUrl="mybaby_jump_taobao_shop";//
	String item_id;
	String isvcode;
	String pid;
	...
	public JumpShopAction() {
		super();
	}

	public JumpShopAction(String item_id, String isvcode, String pid) {
		this.item_id = item_id;
		this.isvcode = isvcode;
		this.pid = pid;
	}
	...
	link.jumpShop(activity, getItem_id(), params);*/
