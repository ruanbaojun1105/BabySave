 ...
 *
 */
public class LoadUrlAction extends Action implements Serializable{
	private static final long serialVersionUID = 1L;
	public static String actionUrl="mybaby_browse_url";//
	String url;
...
public Action setData(String url,Map<String, Object> map) {
	...
	if (url.contains(actionUrl)) {
		...
		return new LoadUrlAction(getUrl());
	}else {
		return null;
	}
}
...
public Boolean excute(Activity activity, UMSocialService webviewController,
	...
	// TODO Auto-generated method stub
	CustomAbsClass.starWebViewIntent(activity,getUrl());
	return  true;
}
